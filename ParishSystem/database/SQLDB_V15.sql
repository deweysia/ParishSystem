...
INSERT INTO `applicant` VALUES (9,8,10),(10,9,11),(11,9,15),(12,8,13),(13,9,13),(14,11,14),(15,11,19);
...
INSERT INTO `application` VALUES (10,1,2,'111'),(11,1,1,'000'),(12,2,2,'000'),(13,3,2,'000000'),(14,1,1,'000'),(15,2,1,'000'),(16,2,1,'000'),(17,2,1,'000'),(18,2,1,'000'),(19,2,1,'000');
...
INSERT INTO `baptism` VALUES (2,10,3,'110','55','336','2017-09-09 00:00:00','',1);
...
INSERT INTO `generalprofile` VALUES (7,'Dewey','L','Sia','','1998-09-26',1,NULL,NULL),(8,'Jim','C','Tang','Jr','2017-09-10',1,'Greyrock','Bridgehaven'),(9,'Dinna','A','Fritze','','2017-09-10',2,'Poston','Bridgehaven'),(11,'Andreia','C','Gaultz','','2017-09-10',2,NULL,NULL),(12,'Andrea','C','Gaultz','','2017-09-10',2,NULL,NULL);
...
INSERT INTO `marriage` VALUES (1,13,3,NULL,NULL,NULL,'2017-09-09','2017-09-09',NULL,NULL,1,1);
...
INSERT INTO `minister` VALUES (3,'Boyle','A','Royce','II','1960-01-02',2,1,NULL,NULL),(4,'Joshua','F','Lintag','','2017-09-12',1,1,NULL,NULL);
...
INSERT INTO `parent` VALUES (3,8,'Harland','C','Outten','',NULL,1,'Tawanna',NULL),(4,8,'Sheryl','E','Seder','',NULL,2,'Valdasia',NULL),(5,9,'Gregory','A','Bisten','',NULL,1,'Coldstone',NULL),(6,9,'Saffron','A','Gedt',NULL,NULL,2,'Addasia',NULL);
...
INSERT INTO `sacramentincome` VALUES (10,10,200,''),(11,11,200,''),(12,15,500,''),(13,13,2000,''),(14,14,500,'New Parish Member'),(15,19,100,'');
...
INSERT INTO `schedule` VALUES (1,'Random Event','','2017-09-12 06:59:00','2017-09-12 06:59:00'),(2,'Meeting','','2017-09-12 10:12:00','2017-09-12 11:12:00');
...
INSERT INTO `sponsor` VALUES (1,12,'Coretta','S','Sircy','',2,'Bathasia'),(2,12,'Augustus','E','Outman','Jr',1,'Quinnia'),(3,10,'Nellia','Q','Depriest','',2,'Peddef'),(4,10,'Sergio','V','Negron','II',1,'Whittingham'),(5,13,'Keith','C','Bamber','',1,'Northcoast'),(6,13,'Wen','A','Glasgow','',1,'Fallholt');
...
-- Dump completed on 2017-09-14 10:24:36
